...
import { ignore0, getTeamColor } from '../../../../api/generic.mjs';
...
function renderTeam(teamId, playerData, matchId, single){
    ...
    for(let i = 0; i < playerData.length; i++){
        ...
        data.push({
            ...
            "flag_taken": {"value": ctf.flag_taken, "displayValue": ignore0(ctf.flag_taken)},
            "flag_pickup": {"value": ctf.flag_pickup, "displayValue": ignore0(ctf.flag_pickup)},
            "flag_dropped": {"value": ctf.flag_dropped, "displayValue": ignore0(ctf.flag_dropped)},
            "flag_suicide": {"value": ctf.flag_suicide, "displayValue": ignore0(ctf.flag_suicide)},
            "flag_assist": {"value": ctf.flag_assist , "displayValue": ignore0(ctf.flag_assist)},
            "flag_cover":  {"value": ctf.flag_cover , "displayValue": ignore0(ctf.flag_cover)},
            "flag_seal":  {"value": ctf.flag_seal , "displayValue": ignore0(ctf.flag_seal)},
            "flag_capture":  {"value": ctf.flag_capture , "displayValue": ignore0(ctf.flag_capture)},
            "flag_kill":  {"value": ctf.flag_kill , "displayValue": ignore0(ctf.flag_kill)},
    ...
    if(!single){
        ...
        const last = {
            "bAlwaysLast": true,
            "player": "Totals",
            "flag_taken": {"value": ignore0(totals.flag_taken) },
            "flag_pickup": {"value": ignore0(totals.flag_pickup) },
            "flag_dropped": {"value": ignore0(totals.flag_dropped) },
            "flag_suicide": {"value": ignore0(totals.flag_suicide) },
            "flag_assist": {"value": ignore0(totals.flag_assist) },
            "flag_cover":  {"value": ignore0(totals.flag_cover) },
            "flag_seal":  {"value": ignore0(totals.flag_seal) },
            "flag_capture":  {"value": ignore0(totals.flag_capture) },
            "flag_kill":  {"value": ignore0(totals.flag_kill) },
...
export default function MatchCTFSummaryDefault({playerData, matchId, single}){
