...
const queries = [
    ...
    `CREATE TABLE IF NOT EXISTS nstats_player_matches (
        ...
        amp_kills int(11) NOT NULL,
        amp_kills_single_life int(11) NOT NULL,
        amp_player_kills int(11) NOT NULL,
        amp_player_kills_single_life int(11) NOT NULL,
        amp_suicides int(11) NOT NULL,
        invisibility int(11) NOT NULL,
        invisibility_time float NOT NULL,
        invisibility_kills int(11) NOT NULL,
        invisibility_kills_single_life int(11) NOT NULL,
    ...
    `CREATE TABLE IF NOT EXISTS nstats_player_totals (
        ...
        amp_time float NOT NULL,
        amp_kills int(11) NOT NULL,
        amp_kills_best int(11) NOT NULL,
        amp_kills_best_life int(11) NOT NULL,
        amp_player_kills int(11) NOT NULL,
        amp_player_kills_best int(11) NOT NULL,
        amp_player_kills_single_life int(11) NOT NULL,
        amp_suicides int(11) NOT NULL,
        amp_suicides_best int(11) NOT NULL,
        invisibility int(11) NOT NULL,
        invisibility_time float NOT NULL,
        invisibility_kills int(11) NOT NULL,
        invisibility_kills_best int(11) NOT NULL,
        invisibility_kills_best_life int(11) NOT NULL,
        pads int(11) NOT NULL,
        armor int(11) NOT NULL,
        boots int(11) NOT NULL,
        super_health int(11) NOT NULL,
