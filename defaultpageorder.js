...
const queries = [
    ...
    `UPDATE nstats_site_settings SET page_order=2 WHERE category="Home" AND name="Display Latest Match"`,
    `UPDATE nstats_site_settings SET page_order=1 WHERE category="Home" AND name="Display Recent Matches"`,
    `UPDATE nstats_site_settings SET page_order=0 WHERE category="Home" AND name="Display Recent Matches & Player Stats"`,
