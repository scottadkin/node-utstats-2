...
const queries = [
    ...
    `INSERT INTO nstats_site_settings VALUES(NULL,"Match Pages","Display Player Ping Graph","true",26)`,
    `INSERT INTO nstats_site_settings VALUES(NULL,"Match Pages","Display Players Connected to Server Graph","true",27)`,
    `INSERT INTO nstats_site_settings VALUES(NULL,"Match Pages","Display Player Score Graph","true",28)`,
    `INSERT INTO nstats_site_settings VALUES(NULL,"Match Pages","Display Team Changes","true",29)`,
    `INSERT INTO nstats_site_settings VALUES(NULL,"Match Pages","Display Time Limit","true",30)`,
    `INSERT INTO nstats_site_settings VALUES(NULL,"Match Pages","Display Server Settings","true",31)`,
    `INSERT INTO nstats_site_settings VALUES(NULL,"Match Pages","Display Target Score","true",32)`,
    `INSERT INTO nstats_site_settings VALUES(NULL,"Match Pages","Display Mutators","true",33)`,
