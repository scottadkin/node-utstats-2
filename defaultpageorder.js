...
const queries = [
    ...
    `UPDATE nstats_site_settings SET page_order=3 WHERE category="Match Pages" AND name="Display Domination Summary"`,
    `UPDATE nstats_site_settings SET page_order=4 WHERE category="Match Pages" AND name="Display Domination Graphs"`,
    `UPDATE nstats_site_settings SET page_order=5 WHERE category="Match Pages" AND name="Display Assault Summary"`,
    `UPDATE nstats_site_settings SET page_order=6 WHERE category="Match Pages" AND name="Display Capture The Flag Summary"`,
    `UPDATE nstats_site_settings SET page_order=7 WHERE category="Match Pages" AND name="Display MonsterHunt Kills"`,
    `UPDATE nstats_site_settings SET page_order=8 WHERE category="Match Pages" AND name="Display Frag Summary"`,
    `UPDATE nstats_site_settings SET page_order=9 WHERE category="Match Pages" AND name="Display Frags Graphs"`,
    `UPDATE nstats_site_settings SET page_order=10 WHERE category="Match Pages" AND name="Display Capture The Flag Graphs"`,
    `UPDATE nstats_site_settings SET page_order=11 WHERE category="Match Pages" AND name="Display Capture The Flag Times"`,
    `UPDATE nstats_site_settings SET page_order=12 WHERE category="Match Pages" AND name="Display Capture The Flag Caps"`,
    `UPDATE nstats_site_settings SET page_order=13 WHERE category="Match Pages" AND name="Display Special Events"`,
    `UPDATE nstats_site_settings SET page_order=14 WHERE category="Match Pages" AND name="Display Extended Sprees"`, 
    `UPDATE nstats_site_settings SET page_order=15 WHERE category="Match Pages" AND name="Display Rankings"`,  
    `UPDATE nstats_site_settings SET page_order=16 WHERE category="Match Pages" AND name="Display Ammo Control"`,
    `UPDATE nstats_site_settings SET page_order=17 WHERE category="Match Pages" AND name="Display Health/Armour Control"`,
    `UPDATE nstats_site_settings SET page_order=18 WHERE category="Match Pages" AND name="Display Weapons Control"`,
    `UPDATE nstats_site_settings SET page_order=19 WHERE category="Match Pages" AND name="Display Powerup Control"`,
    `UPDATE nstats_site_settings SET page_order=20 WHERE category="Match Pages" AND name="Display Power Up Control"`,
    `UPDATE nstats_site_settings SET page_order=21 WHERE category="Match Pages" AND name="Display Pickup Summary"`,
    `UPDATE nstats_site_settings SET page_order=22 WHERE category="Match Pages" AND name="Display Kills Match Up"`,
    `UPDATE nstats_site_settings SET page_order=23 WHERE category="Match Pages" AND name="Display Weapon Statistics"`,
    `UPDATE nstats_site_settings SET page_order=24 WHERE category="Match Pages" AND name="Display Player Ping Graph"`,
    `UPDATE nstats_site_settings SET page_order=25 WHERE category="Match Pages" AND name="Display Player Score Graph"`,  
    `UPDATE nstats_site_settings SET page_order=26 WHERE category="Match Pages" AND name="Display Team Changes"`,
    `UPDATE nstats_site_settings SET page_order=27 WHERE category="Match Pages" AND name="Display Players Connected to Server Graph"`,
    `UPDATE nstats_site_settings SET page_order=28 WHERE category="Match Pages" AND name="Display Server Settings"`,
    `UPDATE nstats_site_settings SET page_order=29 WHERE category="Match Pages" AND name="Display Time Limit"`,
    `UPDATE nstats_site_settings SET page_order=30 WHERE category="Match Pages" AND name="Display Target Score"`,
    `UPDATE nstats_site_settings SET page_order=31 WHERE category="Match Pages" AND name="Display Mutators"`,  
