...
async function updateSiteSettings(){
    ...
    const queries = [
        ...
        `INSERT INTO nstats_site_settings VALUES(126, 'Map Pages', 'Display Combogib Records', 'true', 9);`,
    ...
    const queries = [
        `CREATE TABLE IF NOT EXISTS nstats_match_combogib (
            ...
            `CREATE TABLE IF NOT EXISTS nstats_map_combogib (
                ...
                best_primary_kills int(11) NOT NULL,
                best_primary_kills_player_id int(11) NOT NULL,
                best_primary_kills_match_id int(11) NOT NULL,
                best_ball_kills int(11) NOT NULL,
                best_ball_kills_player_id int(11) NOT NULL,
                best_ball_kills_match_id int(11) NOT NULL,
                best_combo_kills int(11) NOT NULL,
                best_combo_kills_player_id int(11) NOT NULL,
                best_combo_kills_match_id int(11) NOT NULL,
                best_insane_kills int(11) NOT NULL,
