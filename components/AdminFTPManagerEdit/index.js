...
class AdminFTPManagerEdit extends React.Component{
    ...
    renderFormElems(data){
        ...
        return <>
            ...
            <div className="select-row">
                ...
                <div>
                    <FormCheckBox inputName={"bImportAce"} valueName="import_ace"  updateValue={this.updateValue} value={data.import_ace}/>
                </div>
            </div>
    ...
    render(){
        ...
        return <div>          
            <div className="default-header">Edit FTP Servers</div>
            <div className="form">
