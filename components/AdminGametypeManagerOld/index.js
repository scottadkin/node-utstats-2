...
class AdminGametypeManagerOld extends React.Component{
    ...
    renderRenameErrors(){
        ...
        for(let i = 0; i < this.state.renameErrors.length; i++){
            ...
            const e = this.state.renameErrors[i];
    ...
    renderMergeErrors(){
        ...
        for(let i = 0; i < this.state.mergeErrors.length; i++){
            ...
            const e = this.state.mergeErrors[i];
    ...
    renderDeleteErrors(){
        ...
        for(let i = 0; i < this.state.deleteErrors.length; i++){
            ...
            const e = this.state.deleteErrors[i];
...
export default AdminGametypeManagerOld;