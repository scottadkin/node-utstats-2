...
function Nav({session, settings}){
    ...
    return (
        ...
        <header className={styles.header}>
            <div id="beta-message">
                This is an early beta build, there may be problems at first, they will be fixed once reported <a className="yellow" href="https://github.com/scottadkin/node-utstats-2/issues">Here.</a> Build v2.4.0 22nd January 2022
            </div>
